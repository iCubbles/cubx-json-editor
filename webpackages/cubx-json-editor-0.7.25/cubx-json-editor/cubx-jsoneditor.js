...
JSONEditor.AbstractEditor = Class.extend({
  ...
  getLink: function(data) {
    ...
    if(type === 'image') {
      ...
      this.link_watchers.push(function(vars) {
        ...
        link.setAttribute('superior_div',data.rel || url);
  ...
  getHeaderText: function(title_only) {
    ...
    else if(title_only) return this.schema.superior_div;
  ...
  getTitle: function() {
    return this.schema.superior_div || this.key;
  },
  enable: function() {
    this.disabled = false;
  },
  ...
  getDisplayText: function(arr) {
    ...
    $each(arr,function(i,el) {
      if(el.superior_div) {
        used[el.superior_div] = used[el.superior_div] || 0;
        used[el.superior_div]++;
      }
      if(el.description) {
    ...
    $each(arr,function(i,el)  {
      ...
      // Object
      else if(el.superior_div && used[el.superior_div]<=1) name = el.superior_div;
      else if(el.format && used[el.format]<=1) name = el.format;
      else if(el.type && used[el.type]<=1) name = el.type;
      else if(el.description && used[el.description]<=1) name = el.descripton;
      else if(el.superior_div) name = el.superior_div;
...
JSONEditor.defaults.editors.string = JSONEditor.AbstractEditor.extend({
  ...
  setValue: function(value,initial,from_template) {
    ...
    else if(typeof value === "object") value = JSON.stringify(value, null, '   ');
    ...
    if (!this.jsoneditor.options.asViewer) {
    ...
    if (this.format === 'json') {
      hljs.highlightBlock(this.input);
    }
  },
  getNumColumns: function() {
  ...
  build: function() {
    ...
    if(this.parent.options.table_cell){
    ...
    if(this.jsoneditor.options.asViewer){
      if (this.format === 'json') {
        this.input = this.theme.getCodeElement();
      } else {
        this.input = this.theme.getPElement();
      }
      this.input.setAttribute('class', 'compact');
    }else if(this.format) {
      // Text Area
...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
    ...
    */
    ...
    if(this.format === 'grid') {
      ...
      $each(this.property_order, function(j,key) {
        ...
        if(editor.options.emptyProperty) {
          editor.container.className += ' emptyProperty';
          editor.container.style.fontStyle = 'italic';
          editor.container.style.color = '#767676';
        }
      });
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.superior_div = this.theme.getHeader(this.header);
      this.container.appendChild(this.superior_div);
      ...
      this.superior_div.appendChild(this.title_controls);
      this.superior_div.appendChild(this.editjson_controls);
      this.superior_div.appendChild(this.addproperty_controls);
  ...
  addPropertyCheckbox: function(key) {
    ...
    if (this.schema.properties[key] && this.schema.properties[key].superior_div)
      labelText = this.schema.properties[key].superior_div;
    else
      labelText = key;
  ...
  destroy: function() {
    ...
    if(this.superior_div && this.superior_div.parentNode) this.superior_div.parentNode.removeChild(this.superior_div);
  ...
  setValue: function(value, initial) {
    ...
    $each(this.cached_editors, function(i,editor) {
      ...
      if(typeof value[i] !== "undefined" && !(Array.isArray(value[i]) && value[i].length <= 0)) {
        self.addObjectProperty(i);
        editor.setValue(value[i],initial);
      }
      // Otherwise, remove value unless this is the initial set or it's required
      else if(!initial) {
        if (self.jsoneditor.options.hideEmptyProperties) {
          self.editors[i].options.hidden = true;
        }
        self.editors[i].options.emptyProperty = true;
      }
  ...
  hideEmptyProperties: function () {
    var emptyProperties = document.querySelectorAll('.emptyProperty');
    for (var i = 0; i < emptyProperties.length; i++) {
  ...
  showEmptyProperties: function () {
    var emptyProperties = document.querySelectorAll('.emptyProperty');
    for (var i = 0; i < emptyProperties.length; i++) {
      emptyProperties[i].style.display = 'block';
    }
  }
});
...
JSONEditor.defaults.editors.array = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    if(!this.options.compact) {
      this.superior_div = document.createElement('div');
      this.superior_div.style.marginBottom = '3px';
      this.container.appendChild(this.superior_div);
      this.titleSpan = document.createElement('span');
      this.title = this.theme.getHeader(this.titleSpan);
      this.title.textContent = this.getTitle() + ' [0]';
      this.header = document.createElement('div');
      this.header.style.display = 'inline';
      this.header.appendChild(this.title);
      this.superior_div.appendChild(this.header);
      ...
      if(this.schema.format === 'tabs') {
        ...
        this.superior_div.appendChild(this.controls);
  ...
  getItemTitle: function() {
    if(!this.item_title) {
      if(this.schema.items && !Array.isArray(this.schema.items)) {
        ...
        this.item_title = tmp.superior_div || '';
      }
      else {
        this.item_title = '';
      }
  ...
  getItemInfo: function(i) {
    ...
    this.item_info[stringified] = {
      superior_div: schema.superior_div || '',
  ...
  getElementEditor: function(i) {
    ...
    var schema = this.getItemSchema(i);
    schema = this.jsoneditor.expandRefs(schema);
    schema.superior_div = item_info.superior_div+' '+(i+1) + '.';
  ...
  destroy: function() {
    ...
    this.rows = this.row_cache = this.superior_div = this.description = this.row_holder = this.panel = this.controls = null;
  ...
  setValue: function(value, initial) {
    ...
    $each(value,function(i,val) {
      if(self.rows[i]) {
        ...
        if(val){
          self.rows[i].header_text = val.artifactId || val.endpointId || val.slotId || val.connectionId || '';
        }
  ...
  addRow: function(value, initial) {
    ...
    if(self.tabs_holder) {
      ...
      if(value) {
        self.rows[i].header_text = value.artifactId || value.endpointId || value.slotId || value.connectionId;
      }
      ...
      if(self.rows[i].superior_div){
        self.rows[i].toggle_button.style.display = 'none';
        self.rows[i].superior_div.style.display = 'none';
      }
    }
    ...
    if(self.hide_move_buttons && self.hide_delete_buttons && controls_holder){
  ...
  afterAdding: function () {
    this.toggle_button.style.display = 'block';
  ...
  updateCounterText: function () {
    this.title.textContent = this.getTitle() + ' [' + this.rows.length + ']';
  }
});
...
JSONEditor.defaults.editors.table = JSONEditor.defaults.editors.array.extend({
  ...
  preBuild: function() {
    ...
    this.item_title = item_schema.superior_div || 'row';
  ...
  destroy: function() {
    ...
    this.rows = this.superior_div = this.description = this.row_holder = this.table = this.panel = null;
...
JSONEditor.defaults.editors["enum"] = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    var container = this.container;
    this.superior_div = this.header = this.label = this.theme.getFormInputLabel(this.getTitle());
    this.container.appendChild(this.superior_div);
  ...
  preBuild: function() {
    ...
    // Dynamic Enum
      ...
      for(i=0; i<this.enumSource.length; i++) {
        ...
        if(this.enumSource[i].superior_div) {
          this.enumSource[i].superior_div = this.jsoneditor.compileTemplate(this.enumSource[i].superior_div, this.template_engine);
        }
        ...
        if(Array.isArray(this.enumSource[i])) {
          ...
          if(items) {
            ...
            for(j=0; j<items.length; j++) {
              ...
              // Rendered superior_div
              if(this.enumSource[i].superior_div) {
                item_titles[j] = this.enumSource[i].superior_div({
                  i: j,
                  item: item
                });
              }
              // Use value as the superior_div also
              else {
  ...
  build: function() {
    ...
    if((!this.schema.format && this.option_keys.length < 8) || this.schema.format === "checkbox") {
      ...
      for(i=0; i<this.option_keys.length; i++) {
        ...
        if(this.schema.readOnly || this.schema.readonly || this.jsoneditor.options.asViewer) {
          this.inputs[this.option_keys[i]].disabled = true;
        }
      }
...
JSONEditor.defaults.editors.arraySelectize = JSONEditor.AbstractEditor.extend({
  build: function() {
    this.superior_div = this.theme.getFormInputLabel(this.getTitle());
    ...
    var group = this.theme.getFormControl(this.superior_div, this.input, this.description);
...
/**
 * Created by ega on 18.04.2016.
 */
JSONEditor.defaults.editors.function = JSONEditor.AbstractEditor.extend({
  sanitize: function(value) {
    return (value+"").replace(/[^0-9\.\-eE]/g,'');
  },
  getNumColumns: function() {
...
JSONEditor.AbstractTheme = Class.extend({
  ...
  setButtonText: function(button, text, icon, title) {
    ...
    if(title) button.setAttribute('superior_div',title);
  },
  getTable: function() {
...
JSONEditor.defaults.themes.bootstrap3 = JSONEditor.AbstractTheme.extend({
  ...
  afterInputReady: function(input) {
    ...
    if(this.closest(input,'.compact')) {
      input.controlgroup.style.marginBottom = '3px';
    }
  ...
  getDescription: function(text) {
    ...
    el.setAttribute('class', 'glyphicon glyphicon-info-sign');
...
JSONEditor.defaults.themes.jqueryui = JSONEditor.AbstractTheme.extend({
  ...
  getButton: function(text, icon, title) {
    ...
    button.setAttribute('superior_div',title);
...
JSONEditor.defaults.languages.en = {
  ...
  /**
    ...
    * @variable This key takes one variable: The superior_div of object to delete
    */
  ...
  /**
    ...
    * @variable This key takes one variable: The superior_div of object to add
    */
  ...
  /**
    * Title on Delete Row buttons, short version (no parameter with the object superior_div)
    */
...
JSONEditor.defaults.resolvers.unshift(function(schema) {
  // If the schema can be of any type
  if((typeof schema.type !== "string") && schema.format === "json") return "string";
});
...
//# sourceMappingURL=cubx-jsoneditor.js.map
